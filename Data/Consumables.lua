...
addon.Data.Consumables = {
	List = {
		{ zh = "银月城生命药水", en = "Silvermoon Health Potion", itemID = 241304, spellID = 1234768, file = "silvermoonPotion.ogg" },
		...
		{ zh = "狂放恣意饮剂", en = "Draught of Rampant Abandon", itemID = 241292, spellID = 1236998, file = "rampantAbandon.ogg" },
		{ zh = "狂热药水", en = "Potion of Zealotry", itemID = 241296, spellID = 1238443, file = "zealotryPotion.ogg" },
		{ zh = "浓缩银月城生命药水", en = "Concentrated Silvermoon Health Potion", itemID = 271883, spellID = 1295247, file = "concentratedSilvermoon.ogg" },
		...
		{ zh = "焕生治疗药水", en = "Algari Healing Potion", itemID = 244839, spellID = 1238009, file = "algariHealingPotion.ogg" },
		{ zh = "重生猎豹药水", en = "Reborn Cheetah Potion", itemID = 212268, spellID = 431941, file = "rebornCheetahPotion.ogg" },
	},
	Spells = {

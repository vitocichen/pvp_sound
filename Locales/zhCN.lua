...
L:SetStrings({
	...
	["Voice DIY Hint 1"] = "|cFFFFD100如需添加 DIY 语音包，有以下两种方法：|r",
	["Voice DIY Hint 2"] = "|cFFFFD100方法1：输入语音包名字，点击添加创建文件夹，然后把 .ogg 放到该文件夹下；|r",
	["Voice DIY Hint 3"] = "|cFFFFD100方法2：也可以用现成的语音包目录，只替换你要修改的文件。|r",

...
L:SetStrings({
	...
	["home_intro_cast"] = "4.|cFFFFA500读条监控|r：暂无 API，努力实现中",
	...
	["zones_intro_cast"] = "|cFFFFD100读条监控|r：暂无 API，努力实现中。",
	["Enable"] = "开启",
	...
	["changelog_v3.0.2"] = "|cFFFFD100v3.0.2|r — 新增xiaoxiao原TTS语音包，新增配置导入/导出功能，修正和添加/删除了部分法术ID",

...
L:SetStrings({
	...
	["Voice Pack Hint"] = "内置夏一可/晓晓/英语在插件 Media\\ 下。DIY 请放到 Interface\\AddOns\\PVP_Sound_Custom\\包名\\（与主插件并列）。",
	["Voice Pack Select"] = "语音包选择",
	["Voice Pack Select Hint"] = "|cFFFFD100包名里的 1 / 1.25x / 1.5x 表示播放倍速，推荐使用 1.25x。|r",
	["Custom Voice Pack"] = "添加自定义包",
	["Voice DIY Hint 1"] = "|cFFFFD100【重要】不要把 DIY 文件放进 PVP_Sound\\Media\\。更新/覆盖主插件会删掉整个 PVP_Sound，自定义语音会丢。|r",
	["Voice DIY Hint 2"] = "|cFFFFD100正确位置（注意：和 PVP_Sound 文件夹并列，不要放进它里面）：|r",
	["Voice DIY Hint 3"] = "|cFFFFD100  Interface\\AddOns\\PVP_Sound\\              ← 主插件|r",
	["Voice DIY Hint 4"] = "|cFFFFD100  Interface\\AddOns\\PVP_Sound_Custom\\       ← 你新建，更新主插件时请保留|r",
	["Voice DIY Hint 5"] = "|cFFFFD100步骤：① 把本插件里的 CustomPackTemplate 复制到 AddOns，改名为 PVP_Sound_Custom（或自己新建该文件夹，把模板里的 .toc 放进去）。|r",
	["Voice DIY Hint 6"] = "|cFFFFD100② 在 PVP_Sound_Custom 里再新建一个文件夹，名字自定，例如 abc。③ 把 .ogg/.mp3 放进 abc，文件名需和内置包一致（可对照 Media\\夏一可\\）。|r",
	["Voice DIY Hint 7"] = "|cFFFFD100④ 在下方填写 abc，点添加。插件不能替你建文件夹，添加只是让下拉框出现「abc」。然后到上面「语音包选择」里选中它。|r",
	["Voice DIY Hint 8"] = "|cFFFFD100以前已经放在 Media\\ 里的自定义包暂时还能播，建议尽快挪到 PVP_Sound_Custom，以免下次更新再丢失。|r",
	["voice_pack_added"] = "已登记语音包：%s。请把 .ogg 放到 Interface\\AddOns\\PVP_Sound_Custom\\%s\\（与主插件并列）。点添加不会自动建文件夹。",
	["voice_pack_add_failed"] = "包名无效。请填写 PVP_Sound_Custom 下的文件夹名（例如 abc），不要带斜杠或路径。",
	...
	["zones_intro_interrupt"] = "|cFFFFD100打断|r：敌方施法被|cFFFF6060打断|r时播放提示音（无法确认是否由你打断）。",
	...
	["Enable interrupt voice alerts in this zone."] = "敌方施法被打断时播放提示音（无法确认是否由你打断）。音效可在右侧下拉选择。",
	["Monitor Range"] = "监控范围",
	...
	["home_intro_5c"] = "|cFFFFA500打断提醒|r — 敌方施法被打断时播报（可按区域开关，音效可自选）。",

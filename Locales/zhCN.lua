...
L:SetStrings({
	...
	["home_intro_consumable"] = "5.|cFF00BFFF消耗品检测|r：自己使用列表内药水时，自动在喊话频道通报（可在「区域」页按场景开关）。",
	...
	["Enable consumable honesty alerts in this zone."] = "自己使用列表内药水后，会在你下一次按键时自动|cFFFF2020喊话|r通报。取消勾选即可在此区域关闭。",
	["Monitor Range"] = "监控范围",
	...
	["spell_group_consumables"] = "药水列表（喊话开关在「区域」页）",
	["consumable_watch_locked_tooltip"] = "药水列表始终显示。诚实喊话请到「区域」页按场景开关。",

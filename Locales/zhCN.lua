...
L:SetStrings({
	...
	["zones_intro_consumable"] = "|cFFFFD100消耗品|r：自己喝下列表内药水时，在|cFFFF6060说|r频道通报（用于自证，不检测敌人）。",
	...
	["Enable consumable honesty alerts in this zone."] = "自己使用列表内药水后，会在你下一次按键或点击时自动在说频道发送「【pvp_sound检测】我已吃下 xxx」（暴雪禁止插件后台直接说话）。",
	["Monitor Range"] = "监控范围",

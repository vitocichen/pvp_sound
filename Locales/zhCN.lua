...
L:SetStrings({
	...
	["Zones"] = "区域",
	["zones_intro"] = "按区域分别开关敌方 buff、debuff、治疗被控播报；buff/debuff 可设监控范围，治疗被控可选手边音效。",
	["Enable"] = "开启",
	...
	["changelog_v3.0.2"] = "|cFFFFD100v3.0.2|r — 修复盗贼自己对敌人上「君王之灾」也会播报：去掉误登记的施法者自身增益 ID，仅保留打在你/队友身上的减益。",

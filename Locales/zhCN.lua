...
L:SetStrings({
	...
	["Voice DIY Hint 1"] = "|cFFFFD100把本插件里的 PVP_Sound_Custom 复制到 Interface\\AddOns\\，和 PVP_Sound 并列（只需一次）。更新后外层目录不会影响，永久有效；不要删除里面的 .toc 文件。|r",
	["Voice DIY Hint 2"] = "|cFFFFD100在里面用现成文件夹，或自己新建/改名，把 .ogg 放进去（文件名对照 Media\\夏一可\\）。|r",
	["Voice DIY Hint 3"] = "|cFFFFD100下方填写这个文件夹的名字，点添加，再到上方下拉框选中。点添加的都走 PVP_Sound_Custom，不会自动建文件夹。|r",

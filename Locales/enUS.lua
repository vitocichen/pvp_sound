...
L:SetDefaultStrings({
	...
	["home_intro_consumable"] = "5. |cFF00BFFFConsumables|r: World only — /yell when you use a listed potion. Off in arena / BG / instances. Optional duel-watch while you are out of combat.",
	...
	["Copy"] = "Copy",
	["Copied"] = "Copied",
	["consumable_say_prefix"] = "!![PVP_SOUND] I used a",
	["consumable_say_format"] = "!![PVP_SOUND] I used a [%s] potion!!",
	["consumable_watch_say_format"] = "!![PVP_SOUND] Detected player [%s] drank a [%s] potion!!",
	["consumable_watch_pending_hint"] = "!![PVP_SOUND] Detected player [%s] drank a [%s] potion!!",
	...
	["zones_intro_consumable"] = "|cFFFFD100Consumables|r: |cFF00FF00World only|r — /yell when you use a listed potion. Off in arena / BG / instances.",
	["zones_intro_duel_potion"] = "|cFFFFD100Duel potion watch|r: World only, out of combat. After a listed potion buff on a nearby player, press any key to /yell. Debug prints stay on.",
	...
	["Enable Duel Potion Watch"] = "Duel potion watch yell",
	["Enable Duel Potion Watch Tooltip"] = "World + out of combat. Listed potion buffs queue a /yell on the next keypress. Other buffs print to chat only. Honesty yell for your own potions is unchanged.",
	...
	["home_intro_5c"] = "|cFFFFA500Interrupt Alert|r - Plays when you successfully interrupt an enemy cast (per-zone toggle, selectable clip).",
	...
	["healer_cc_tts_default"] = "Healer CC'd",
	["The text to speak when enemy healer is CCed."] = "The text to speak when the friendly healer is CCed.",
	["Healer CC Sound Hint"] = "Choose Xia Yike Control Success, voice-pack Sonar, or the v2.0.3 PS_ alert clips.",

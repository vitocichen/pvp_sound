...
L:SetDefaultStrings({
	...
	["home_intro_consumable"] = "5. |cFF00BFFFConsumables|r: when you use a listed potion, auto-yell (toggle per zone on the Zones tab).",
	...
	["zones_intro_consumable"] = "|cFFFFD100Consumables|r: when you use a listed potion, announce it in |cFFFF2020Yell|r (self-proof; enemies cannot be detected).",
	...
	["Enable consumable honesty alerts in this zone."] = "When you use a listed potion, /yell on your next keypress. Uncheck to disable in this zone.",
	...
	["spell_group_consumables"] = "Potion list (honesty yell is toggled per zone)",
	["consumable_watch_locked_tooltip"] = "This list is always shown. Turn the honesty yell on or off on the Zones tab.",

...
L:SetDefaultStrings({
	...
	["home_intro_consumable"] = "5. |cFF00BFFFConsumables|r: when you use a listed potion, auto-announce in Say.",
	...
	["Voice DIY Hint 3"] = "3. Put audio files in PVP_Sound_Custom\\your pack folder\\; filenames must match the 夏一可 pack",
	...
	["Enable Consumable Say"] = "Consumable honesty /say",
	...
	["Enable consumable honesty alerts in this zone."] = "When you use a listed potion, /yell on your next key or click. The General Spells potion list is always on.",

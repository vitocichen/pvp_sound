...
L:SetDefaultStrings({
	...
	["changelog_v3.0.11"] = "|cFFFFD100v3.0.11|r — Added more spell IDs; potion detection now only works in open-world duels; fixed action-bar lock in arena and dungeons.",

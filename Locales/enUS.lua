...
L:SetDefaultStrings({
	...
	["home_intro_consumable"] = "5. |cFF00BFFFConsumables|r: when you use a listed potion, auto-yell in Yell (always on).",
	...
	["spell_group_consumables"] = "Potion detect (always on, cannot disable)",
	["consumable_watch_locked_tooltip"] = "Potion detection is always on and cannot be toggled per item.",

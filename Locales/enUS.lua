...
L:SetDefaultStrings({
	...
	["Voice Pack Hint"] = "Built-in packs stay in Media\\. DIY packs go in Interface\\AddOns\\PVP_Sound_Custom\\<pack>\\ (sibling of PVP_Sound).",
	...
	["Voice DIY Hint 1"] = "|cFFFFD100[Important] Do not put DIY files in PVP_Sound\\Media\\. Updating the addon replaces that folder and your clips will be deleted.|r",
	["Voice DIY Hint 2"] = "|cFFFFD100Correct location (sibling of PVP_Sound, NOT inside it):|r",
	["Voice DIY Hint 3"] = "|cFFFFD100  Interface\\AddOns\\PVP_Sound\\              <- main addon|r",
	["Voice DIY Hint 4"] = "|cFFFFD100  Interface\\AddOns\\PVP_Sound_Custom\\       <- you create this; keep it when updating|r",
	["Voice DIY Hint 5"] = "|cFFFFD100Steps: (1) Copy CustomPackTemplate from this addon into AddOns and rename it to PVP_Sound_Custom (or create that folder and copy the .toc into it).|r",
	["Voice DIY Hint 6"] = "|cFFFFD100(2) Inside PVP_Sound_Custom create a pack folder, e.g. abc. (3) Put .ogg/.mp3 files there; names must match the built-in pack (see Media\\夏一可\\).|r",
	["Voice DIY Hint 7"] = "|cFFFFD100(4) Type abc below and click Add. Add does NOT create folders; it only shows abc in the dropdown. Then select it under Voice Pack.|r",
	["Voice DIY Hint 8"] = "|cFFFFD100Legacy DIY folders still under Media\\ still play; move them to PVP_Sound_Custom so the next update will not wipe them.|r",
	["voice_pack_added"] = "Registered voice pack: %s. Put .ogg in Interface\\AddOns\\PVP_Sound_Custom\\%s\\ (sibling of the main addon). Add does not create the folder.",
	["voice_pack_add_failed"] = "Invalid pack name. Use a folder name under PVP_Sound_Custom (e.g. abc), with no slashes.",

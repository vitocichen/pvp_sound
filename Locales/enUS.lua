...
L:SetDefaultStrings({
	...
	["Voice DIY Hint 1"] = "|cFFFFD100Copy PVP_Sound_Custom from this addon into Interface\\AddOns\\, next to PVP_Sound (once). Later updates will not touch that outer folder; it stays valid permanently. Do not delete the .toc file inside it.|r",
	["Voice DIY Hint 2"] = "|cFFFFD100Use a folder already inside it, or create/rename your own, and put .ogg there (filenames match Media\\夏一可\\).|r",
	["Voice DIY Hint 3"] = "|cFFFFD100Type that folder name below, click Add, then select it. Added packs always use PVP_Sound_Custom. Add does not create folders.|r",

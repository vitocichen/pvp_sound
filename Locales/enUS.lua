...
L:SetDefaultStrings({
	...
	["home_intro_cast"] = "4. |cFFFFA500Cast bar|r: no API yet — work in progress.",
	...
	["zones_intro_cast"] = "|cFFFFD100Cast bar|r: no API yet — work in progress.",
	["Enable"] = "Enable",
	...
	["changelog_v3.0.2"] = "|cFFFFD100v3.0.2|r — Added Xiaoxiao original TTS voice packs, added profile import/export, and fixed/added/removed some spell IDs.",
	...
	["Healer CC Sound Pack"] = "Healer CC (current voice pack)",
	...
	["Interrupt Sound Pack"] = "Interrupted (current voice pack)",
